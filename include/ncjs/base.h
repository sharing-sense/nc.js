...
#define NCJS_DEFINE_OBJECT_PROPERTY(_TYPE, _OBJECT, _KEY, _VALUE, _ATTRIBUTE) do \
	{ \
        _OBJECT->SetValue(_KEY, CefV8Value::CreateObject(_VALUE, NULL), _ATTRIBUTE); \
	} while (0)
...
#define NCJS_PROPERTY_OBJECT_CONST(_TYPE, _OBJECT, _KEY, _VALUE) \
    NCJS_DEFINE_OBJECT_PROPERTY(_TYPE, _OBJECT, _KEY, _VALUE, \
        CefV8Value::PropertyAttribute(V8_PROPERTY_ATTRIBUTE_READONLY | V8_PROPERTY_ATTRIBUTE_DONTDELETE))
